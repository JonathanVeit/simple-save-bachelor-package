...
namespace SimpleSave
{
    internal class SettingsWindow : EditorWindow
    {
        ...
        private static void DrawGeneralSettings(SerializedObject serializedSettings)
        {
            ...
            {
                var specifiedLocationProperty = serializedSettings.FindProperty("SpecifiedLocation");
                var stringValue = specifiedLocationProperty.stringValue;
                ...
                specifiedLocationProperty.stringValue = stringValue;

                EditorGUILayout.PropertyField(specifiedLocationProperty, new GUIContent("Specified", SpecifiedLocationTooltip));
            }
            ...
            EditorGUILayout.PropertyField(serializedSettings.FindProperty("OverrideSavegames"), new GUIContent("Override Savegames", OverrideSaveGamesTooltip));
        }
        ...
        private void DrawAdvancedSettings(SerializedObject serializedSettings)
        {
            DrawFoldout("Advanced Settings", 1, ref _specificSettingsFoldout, () =>
            {
                ...
                {
                    EditorGUILayout.PropertyField(serializedSettings.FindProperty("SavegameEndCondition"), new GUIContent("End Savegame Condition", SaveGameEndConditionTooltip));
